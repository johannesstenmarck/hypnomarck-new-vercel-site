export default function AboutContent({ openBooking, headingLevel = "h1" }) {
  ...
  return (
      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-emerald-950/60 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-emerald-700/30 mb-16">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="order-2 md:order-2">
              <Heading className="text-3xl md:text-5xl font-serif text-white drop-shadow-lg mb-8 font-medium text-center md:text-left">Johannes Stenmarck – hypnoterapeut och förändringscoach</Heading>
        ...
        <div id="free-session" className="scroll-mt-32 max-w-4xl mx-auto text-center pb-8">
